...
//"""
/*
* 1) The songs field of type ArrayList should have been replaced with a SongList type, and therefore the instance created in the constructor needs to be of type SongList.



2) From each addToPlayList method, call their respective findSong methods in SongList to check if the trackNumber/title exists before proceeding.*/
public class Main {
