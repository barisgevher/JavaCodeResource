...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Robin Hood: " + robinHood);
        ...
        printData("Symmetrick Dİfference: phones and emails", symmetricDiff);

        Set<Contact> symmetricDiff2 = new HashSet<>(unionAb);
        symmetricDiff.removeAll(intersectAB);
        printData("Symmetrick Dİfference: phones and emails", symmetricDiff2);
