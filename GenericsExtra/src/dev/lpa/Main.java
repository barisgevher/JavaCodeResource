...
//        QueryList<Employee> employeeList = new QueryList<>(); // Type parameter 'dev. lpa. Employee' is not within its bound; should extend 'dev. lpa. model. Student
...
//        students.set(0, last);   // compiler error capture of ? extends Student
